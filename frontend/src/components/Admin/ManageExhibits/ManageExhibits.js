...
import { Map, Search, Plus, Edit2, Trash2, ChevronUp, ChevronDown, ChevronsUpDown, Star, Image as ImageIcon } from 'lucide-react';
      ...
      <div className="admin-table-container">
        ...
        {!isLoading && table.getPageCount() > 1 && (
          <div className="admin-table-pagination">
            <span className="admin-pagination-info">Page {table.getState().pagination.pageIndex + 1} of {table.getPageCount()} · {filteredExhibits.length} records</span>
