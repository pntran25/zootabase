...
import {
  FileText, ChevronDown, ChevronRight, PawPrint, HeartPulse,
    ...
    <div className="admin-page">
      <div className="admin-page-header">
        <div className="admin-page-title-group">
          ...
          <div>
            <h1 className="admin-page-title">Animal Data Report</h1>
      ...
      {!loading && !report && selectedAnimalId && (
        <div className="admin-table-empty">No data found for this animal.</div>
      )}

      {!loading && !selectedAnimalId && (
        <div className="ah-empty">
          <PawPrint size={40} style={{ color: 'var(--adm-text-muted)' }} />
          <p>Select an animal above to generate a full data report.</p>
        </div>
      )}
        ...
        <div className="ar-sections">
          ...
          <Section icon={<PawPrint size={16} color="var(--adm-accent)" />} title="Animal Profile" defaultOpen={true}>
            <div className="ar-profile">
              ...
              <div className="ar-profile-item"><span className="ar-profile-label">Species</span><span className="ar-profile-value">{a.Species}</span></div>
