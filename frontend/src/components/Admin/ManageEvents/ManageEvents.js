...
import { CalendarDays, Search, Plus, Edit2, Trash2, ChevronUp, ChevronDown, ChevronsUpDown, ChevronLeft, ChevronRight, Star, Image as ImageIcon } from 'lucide-react';
          ...
          return (
            <div className="admin-table-pagination" style={{ borderTop: '1px solid var(--adm-border)' }}>
              <span className="admin-pagination-info">
                Page {pi + 1} of {pageCount} · {filteredEvents.length} records
              </span>
