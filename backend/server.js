...
`IF COL_LENGTH('Animal','ImageUrl') IS NULL ALTER TABLE Animal ADD ImageUrl NVARCHAR(255) NULL`,
`IF COL_LENGTH('Animal','Diet') IS NULL ALTER TABLE Animal ADD Diet NVARCHAR(100) NULL`,
`IF COL_LENGTH('Animal','HealthStatus') IS NULL ALTER TABLE Animal ADD HealthStatus NVARCHAR(50) NULL`,
